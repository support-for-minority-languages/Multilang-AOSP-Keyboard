...
public class Event {
    ...
    // other cases).
    final public SuggestedWords.SuggestedWordInfo mSuggestedWordInfo;
    ...
    private Event(final int type, final CharSequence text, final int codePoint, final int keyCode,
            final int x, final int y, final SuggestedWords.SuggestedWordInfo suggestedWordInfo, final int flags,
            final Event next) {
        mEventType = type;
        mText = text;
     ...
     */
    public static Event createSuggestionPickedEvent(final SuggestedWords.SuggestedWordInfo suggestedWordInfo) {
