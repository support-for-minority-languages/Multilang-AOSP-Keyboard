...
public final class CustomInputStyleSettingsFragment extends PreferenceFragment {
    ...
    static final class SubtypeLocaleAdapter extends ArrayAdapter<SubtypeLocaleItem> {
        ...
        public static SubtypeLocaleItem createItem(final Context context,
            ...
            if (localeString.equals(SubtypeLocaleUtils.NO_LANGUAGE)) {
                final String displayName = context.getString(com.udmurtlyk.extrainputmethod.latin.R.string.subtype_no_language);
    ...
    static final class SubtypePreference extends DialogPreference
        ...
        public SubtypePreference(final Context context, final InputMethodSubtype subtype,
                final SubtypeDialogProxy proxy) {
            super(context, null);
            setDialogLayoutResource(com.udmurtlyk.extrainputmethod.latin.R.layout.additional_subtype_dialog);
            setPersistent(false);
            mProxy = proxy;
            setSubtype(subtype);
        }
        ...
        public void setSubtype(final InputMethodSubtype subtype) {
            ...
            if (isIncomplete()) {
                setTitle(null);
                setDialogTitle(com.udmurtlyk.extrainputmethod.latin.R.string.add_style);
        ...
        protected View onCreateDialogView() {
            ...
            mSubtypeLocaleSpinner = (Spinner) v.findViewById(com.udmurtlyk.extrainputmethod.latin.R.id.subtype_locale_spinner);
            mSubtypeLocaleSpinner.setAdapter(mProxy.getSubtypeLocaleAdapter());
            mKeyboardLayoutSetSpinner = (Spinner) v.findViewById(com.udmurtlyk.extrainputmethod.latin.R.id.keyboard_layout_set_spinner);
        ...
        protected void onPrepareDialogBuilder(final AlertDialog.Builder builder) {
            ...
            if (isIncomplete()) {
                builder.setPositiveButton(com.udmurtlyk.extrainputmethod.latin.R.string.add, this)
                        .setNegativeButton(android.R.string.cancel, this);
            } else {
                builder.setPositiveButton(com.udmurtlyk.extrainputmethod.latin.R.string.save, this)
                        .setNeutralButton(android.R.string.cancel, this)
                        .setNegativeButton(com.udmurtlyk.extrainputmethod.latin.R.string.remove, this);
    ...
    public void onCreate(final Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(com.udmurtlyk.extrainputmethod.latin.R.xml.additional_subtype_settings);
    ...
    private void showSubtypeAlreadyExistsToast(final InputMethodSubtype subtype) {
        ...
        final String message = res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.custom_input_style_already_exists,
                SubtypeLocaleUtils.getSubtypeDisplayNameInSystemLocale(subtype));
    ...
    private AlertDialog createDialog() {
        ...
        builder.setTitle(com.udmurtlyk.extrainputmethod.latin.R.string.custom_input_styles_title)
                .setMessage(com.udmurtlyk.extrainputmethod.latin.R.string.custom_input_style_note_message)
                .setNegativeButton(com.udmurtlyk.extrainputmethod.latin.R.string.not_now, null)
                .setPositiveButton(com.udmurtlyk.extrainputmethod.latin.R.string.enable, new DialogInterface.OnClickListener() {
                    @Override
    ...
    public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
        inflater.inflate(com.udmurtlyk.extrainputmethod.latin.R.menu.add_style, menu);
    }

    @Override
    public boolean onOptionsItemSelected(final MenuItem item) {
        final int itemId = item.getItemId();
        if (itemId == com.udmurtlyk.extrainputmethod.latin.R.id.action_add_style) {
