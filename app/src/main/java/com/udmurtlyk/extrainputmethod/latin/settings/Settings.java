...
public final class Settings implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static boolean readKeypressSoundEnabled(final SharedPreferences prefs,
        ...
        return prefs.getBoolean(PREF_SOUND_ON,
                res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_default_sound_enabled));
    }
    ...
    public static boolean readVibrationEnabled(final SharedPreferences prefs,
        ...
        return hasVibrator && prefs.getBoolean(PREF_VIBRATE_ON,
                res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_default_vibration_enabled));
    }
    ...
    public static boolean readAutoCorrectEnabled(final String currentAutoCorrectionSetting,
        ...
        final String autoCorrectionOff = res.getString(
                com.udmurtlyk.extrainputmethod.latin.R.string.auto_correction_threshold_mode_index_off);
    ...
    public static boolean readBlockPotentiallyOffensive(final SharedPreferences prefs,
        ...
        return prefs.getBoolean(PREF_BLOCK_POTENTIALLY_OFFENSIVE,
                res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_block_potentially_offensive));
    }
    ...
    public static boolean readFromBuildConfigIfGestureInputEnabled(final Resources res) {
        ...
        return res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_gesture_input_enabled_by_build_config);
    }

    public static boolean readGestureInputEnabled(final SharedPreferences prefs,
            final Resources res) {
        boolean defaultGestureInput =
                res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_gesture_input_default_value);
    ...
    public static boolean readPhraseGestureEnabled(final SharedPreferences prefs,
        ...
        return prefs.getBoolean(PREF_PHRASE_GESTURE_ENABLED,
                res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_default_phrase_gesture_enabled));
    }

    public static boolean readFromBuildConfigIfToShowKeyPreviewPopupOption(final Resources res) {
        return res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_enable_show_key_preview_popup_option);
    }

    public static boolean readKeyPreviewPopupEnabled(final SharedPreferences prefs,
            final Resources res) {
        final boolean defaultKeyPreviewPopup = res.getBoolean(
                com.udmurtlyk.extrainputmethod.latin.R.bool.config_default_key_preview_popup);
    ...
    public static int readKeyPreviewPopupDismissDelay(final SharedPreferences prefs,
        ...
        return Integer.parseInt(prefs.getString(PREF_KEY_PREVIEW_POPUP_DISMISS_DELAY,
                Integer.toString(res.getInteger(
                        com.udmurtlyk.extrainputmethod.latin.R.integer.config_key_preview_linger_timeout))));
    }
    ...
    public static float readDefaultKeypressSoundVolume(final Resources res) {
        return Float.parseFloat(ResourceUtils.getDeviceOverrideValue(res,
                com.udmurtlyk.extrainputmethod.latin.R.array.keypress_volumes, DEFAULT_KEYPRESS_SOUND_VOLUME));
    }
    ...
    public static int readDefaultKeyLongpressTimeout(final Resources res) {
        return res.getInteger(com.udmurtlyk.extrainputmethod.latin.R.integer.config_default_longpress_key_timeout);
    }
    ...
    public static int readDefaultKeypressVibrationDuration(final Resources res) {
        return Integer.parseInt(ResourceUtils.getDeviceOverrideValue(res,
                com.udmurtlyk.extrainputmethod.latin.R.array.keypress_vibration_durations, DEFAULT_KEYPRESS_VIBRATION_DURATION));
    }
    ...
    public static boolean readUseFullscreenMode(final Resources res) {
        return res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.config_use_fullscreen_mode);
    }
