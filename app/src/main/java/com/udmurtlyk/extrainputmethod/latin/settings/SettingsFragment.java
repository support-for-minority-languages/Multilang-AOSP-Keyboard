...
public final class SettingsFragment extends InputMethodSettingsFragment {
    ...
    public void onCreate(final Bundle icicle) {
        ...
        setInputMethodSettingsCategoryTitle(com.udmurtlyk.extrainputmethod.latin.R.string.language_selection_title);
        setSubtypeEnablerTitle(com.udmurtlyk.extrainputmethod.latin.R.string.select_language);
        addPreferencesFromResource(com.udmurtlyk.extrainputmethod.latin.R.xml.prefs);
    ...
    public void onCreateOptionsMenu(final Menu menu, final MenuInflater inflater) {
        if (FeedbackUtils.isHelpAndFeedbackFormSupported()) {
            menu.add(NO_MENU_GROUP, MENU_HELP_AND_FEEDBACK /* itemId */,
                    MENU_HELP_AND_FEEDBACK /* order */, com.udmurtlyk.extrainputmethod.latin.R.string.help_and_feedback);
        }
