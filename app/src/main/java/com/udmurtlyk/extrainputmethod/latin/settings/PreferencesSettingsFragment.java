...
public final class PreferencesSettingsFragment extends SubScreenFragment {
    ...
    public void onCreate(final Bundle icicle) {
        ...
        addPreferencesFromResource(com.udmurtlyk.extrainputmethod.latin.R.xml.prefs_screen_preferences);
        ...
        final boolean showVoiceKeyOption = res.getBoolean(
                com.udmurtlyk.extrainputmethod.latin.R.bool.config_enable_show_voice_key_option);
    ...
    public void onResume() {
        ...
        if (voiceInputKeyOption != null) {
            ...
            voiceInputKeyOption.setSummary(
                    isShortcutImeEnabled ? null : getText(com.udmurtlyk.extrainputmethod.latin.R.string.voice_input_disabled_summary));
        }
    }
