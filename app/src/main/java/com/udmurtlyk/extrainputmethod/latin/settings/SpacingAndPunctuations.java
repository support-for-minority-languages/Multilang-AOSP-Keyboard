...
import com.udmurtlyk.extrainputmethod.latin.PunctuationSuggestions;
...
public final class SpacingAndPunctuations {
    ...
    public SpacingAndPunctuations(final Resources res) {
        ...
        mSortedSymbolsPrecededBySpace = StringUtils.toSortedCodePointArray(
                res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.symbols_preceded_by_space));
        ...
        mSortedSymbolsFollowedBySpace = StringUtils.toSortedCodePointArray(
                res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.symbols_followed_by_space));
        mSortedSymbolsClusteringTogether = StringUtils.toSortedCodePointArray(
                res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.symbols_clustering_together));
        ...
        mSortedWordConnectors = StringUtils.toSortedCodePointArray(
                res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.symbols_word_connectors));
        mSortedWordSeparators = StringUtils.toSortedCodePointArray(
                res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.symbols_word_separators));
        mSentenceSeparator = res.getInteger(com.udmurtlyk.extrainputmethod.latin.R.integer.sentence_separator);
        mSentenceSeparatorAndSpace = new String(new int[] {
                mSentenceSeparator, Constants.CODE_SPACE }, 0, 2);
        mCurrentLanguageHasSpaces = res.getBoolean(com.udmurtlyk.extrainputmethod.latin.R.bool.current_language_has_spaces);
        ...
        final String[] suggestPuncsSpec = MoreKeySpec.splitKeySpecs(
                res.getString(com.udmurtlyk.extrainputmethod.latin.R.string.suggested_punctuations));
