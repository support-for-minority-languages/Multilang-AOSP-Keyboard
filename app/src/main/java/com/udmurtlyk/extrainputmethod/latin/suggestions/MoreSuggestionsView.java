...
package com.udmurtlyk.extrainputmethod.latin.suggestions;
...
public final class MoreSuggestionsView extends MoreKeysKeyboardView {
    ...
    public void setKeyboard(final Keyboard keyboard) {
        ...
        if (mAccessibilityDelegate != null) {
            mAccessibilityDelegate.setOpenAnnounce(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_open_more_suggestions);
            mAccessibilityDelegate.setCloseAnnounce(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_close_more_suggestions);
        }
    }
