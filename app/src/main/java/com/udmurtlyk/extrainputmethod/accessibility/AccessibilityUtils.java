...
import com.udmurtlyk.extrainputmethod.compat.SettingsSecureCompatUtils;
...
public final class AccessibilityUtils {
        ...
        if (!TextUtils.isEmpty(mAutoCorrectionWord)) {
            if (!TextUtils.equals(mAutoCorrectionWord, mTypedWord)) {
                if (shouldObscure) {
                    ...
                    return mContext.getString(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_auto_correct_obscured,
                            keyCodeDescription);
                }
                return mContext.getString(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_auto_correct, keyCodeDescription,
    ...
    public void onStartInputViewInternal(final View view, final EditorInfo editorInfo,
        ...
        if (shouldObscureInput(editorInfo)) {
            final CharSequence text = mContext.getText(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_use_headphones);
