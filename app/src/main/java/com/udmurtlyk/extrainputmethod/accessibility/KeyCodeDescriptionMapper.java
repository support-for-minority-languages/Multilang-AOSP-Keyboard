...
package com.udmurtlyk.extrainputmethod.accessibility;
...
final class KeyCodeDescriptionMapper {
    ...
    private static final int OBSCURED_KEY_RES_ID = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_dot;
    ...
    private KeyCodeDescriptionMapper() {
        ...
        mKeyCodeMap.put(Constants.CODE_SPACE, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_space);
        mKeyCodeMap.put(Constants.CODE_DELETE, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_delete);
        mKeyCodeMap.put(Constants.CODE_ENTER, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_return);
        mKeyCodeMap.put(Constants.CODE_SETTINGS, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_settings);
        mKeyCodeMap.put(Constants.CODE_SHIFT, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_shift);
        mKeyCodeMap.put(Constants.CODE_SHORTCUT, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_mic);
        mKeyCodeMap.put(Constants.CODE_SWITCH_ALPHA_SYMBOL, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_to_symbol);
        mKeyCodeMap.put(Constants.CODE_TAB, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_tab);
        mKeyCodeMap.put(Constants.CODE_LANGUAGE_SWITCH,
                com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_language_switch);
        mKeyCodeMap.put(Constants.CODE_ACTION_NEXT, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_action_next);
        mKeyCodeMap.put(Constants.CODE_ACTION_PREVIOUS,
                com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_action_previous);
        mKeyCodeMap.put(Constants.CODE_EMOJI, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_emoji);
        ...
        mKeyCodeMap.put(0x0049, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_letter_0049);
        mKeyCodeMap.put(0x0130, com.udmurtlyk.extrainputmethod.latin.R.string.spoken_letter_0130);
    }
    ...
    public String getDescriptionForKey(final Context context, final Keyboard keyboard,
        ...
        if (code != Constants.CODE_UNSPECIFIED) {
            ...
            return context.getString(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_unknown);
        }
        return null;
    }
    ...
    private static String getDescriptionForSwitchAlphaSymbol(final Context context,
        ...
        case KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_to_symbol;
            break;
        case KeyboardId.ELEMENT_SYMBOLS:
        case KeyboardId.ELEMENT_SYMBOLS_SHIFTED:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_to_alpha;
            break;
        case KeyboardId.ELEMENT_PHONE:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_to_symbol;
            break;
        case KeyboardId.ELEMENT_PHONE_SYMBOLS:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_to_numeric;
            break;
        default:
    ...
    private static String getDescriptionForShiftKey(final Context context,
        ...
        case KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCK_SHIFTED:
        case KeyboardId.ELEMENT_ALPHABET_SHIFT_LOCKED:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_caps_lock;
            break;
        case KeyboardId.ELEMENT_ALPHABET_AUTOMATIC_SHIFTED:
        case KeyboardId.ELEMENT_ALPHABET_MANUAL_SHIFTED:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_shift_shifted;
            break;
        case KeyboardId.ELEMENT_SYMBOLS:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_symbols_shift;
            break;
        case KeyboardId.ELEMENT_SYMBOLS_SHIFTED:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_symbols_shift_shifted;
            break;
        default:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_shift;
        }
        return context.getString(resId);
    }
    ...
    private static String getDescriptionForActionKey(final Context context, final Keyboard keyboard,
        ...
        case EditorInfo.IME_ACTION_SEARCH:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_search;
            break;
        case EditorInfo.IME_ACTION_GO:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.label_go_key;
            break;
        case EditorInfo.IME_ACTION_SEND:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.label_send_key;
            break;
        case EditorInfo.IME_ACTION_NEXT:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.label_next_key;
            break;
        case EditorInfo.IME_ACTION_DONE:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.label_done_key;
            break;
        case EditorInfo.IME_ACTION_PREVIOUS:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.label_previous_key;
            break;
        default:
            resId = com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_return;
        }
        return context.getString(resId);
    }
    ...
    private String getSpokenAccentedLetterDescription(final Context context, final int code) {
        ...
        return isUpperCase ? context.getString(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_upper_case, spokenText)
                : spokenText;
    }
    ...
    private String getSpokenSymbolDescription(final Context context, final int code) {
        ...
        return context.getString(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_symbol_unknown);
    }
    ...
    private String getSpokenEmojiDescription(final Context context, final int code) {
        ...
        return context.getString(com.udmurtlyk.extrainputmethod.latin.R.string.spoken_emoji_unknown);
    }
    ...
    private int getSpokenDescriptionId(final Context context, final int code,
        ...
        final String resourcePackageName = resources.getResourcePackageName(
                com.udmurtlyk.extrainputmethod.latin.R.string.spoken_description_unknown);
